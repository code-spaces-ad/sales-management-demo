...
@php
    $headline = config('consts.title.sale.menu.deposit.create');
    $next_url = route('sale.deposits.store');
    ...
    $is_closing = false;
    $order_number = '新規';
    if (Route::currentRouteName() === 'sale.deposits.edit') {
        $headline = config('consts.title.sale.menu.deposit.edit');
        $next_url = route('sale.deposits.update', $target_record_data['id']);
        $next_btn_text = '更新';
        $method = 'PUT';
        $is_edit_route = true;
...
@section('content')
    ...
    <div class="row">
        ...
        @else
            <div class="row col-md-12 pb-1 pt-1 mb-2 btn-warning" style="font-size: 1.5em;display: none;"
                ...
                現在入力中の得意先・伝票日付は締データが存在するため登録できません。
            </div>
        @endif
                            ...
                            <div class="col-md-4 pl-0">
                                <div class="d-md-inline-flex col-md-12 pr-md-0 pl-0">
                                    <select name="transaction_type_id"
                                            ...
                                            onchange="checkChargeClosed(true);">
                        ...
                        <div class="form-group d-md-inline-flex col-md-6 my-1">
                            ...
                            <div class="col-md-4 pl-0">
                                ...
                                <input type="date" name="order_date" id="order_date" value="{{ old('order_date', $target_record_data['order_date'] ?? $default_order_date) }}"
                                       ...
                                       onchange="changeOrderDate();checkChargeClosed(true);" >
                            ...
                            <div class="flex-md-column col-md-9 pr-md-0 pl-0">
                                <div class="d-md-inline-flex col-md-12 pr-md-0 pl-0">
                                    ...
                                    <input type="number" id="customer_code" oninput="inputCode(this);"
                                           ...
                                           onchange="changeCustomerCodeCreateEdit(this);checkChargeClosed(true);"
                                           maxlength="{{ $maxlength_customer_code }}" min="{{ $min_customer_code }}"
                                           value="{{ $target_record_data->customer_code_zero_fill }}"
                                           placeholder="得意先コード">
                                    {{-- 得意先1 --}}
                                    <select name="customer_id"
                                            onchange="changeCustomerCreateEdit();;checkChargeClosed(true);"
                                        ...
                                        @foreach (($input_items['customers'] ?? []) as $item)
                                            <option
                                                ...
                                                data-billing-balance="{{ $item['billing_balance'] }}"
                    ...
                    <div class="row col-md-12">
                        <div class="d-md-inline-flex col-sm-12 mb-2">
                            ...
                            <div class="col-sm-4 d-inline-flex">
                                ...
                                <input type="text" name="amount_cash" id="amount_cash" value="{{ old('amount_cash', $target_record_data['depositOrderDetail']['amount_cash_comma'] ?? 0) }}"
                            ...
                            <div class="col-sm-5 d-inline-flex">
                                ...
                                <input type="text" name="note_cash" id="note_cash" value="{{ old('note_cash', $target_record_data['depositOrderDetail']['note_cash'] ?? null) }}"
                    ...
                    <div class="row col-md-12">
                        <div class="d-md-inline-flex col-sm-12 mb-2">
                            ...
                            <div class="col-sm-4 d-inline-flex">
                                ...
                                <input type="text" name="amount_check" id="amount_check" value="{{ old('amount_check', $target_record_data['depositOrderDetail']['amount_check_comma'] ?? 0) }}"
                            ...
                            <div class="col-sm-5 d-inline-flex">
                                ...
                                <input type="text" name="note_check" id="note_check" value="{{ old('note_check', $target_record_data['depositOrderDetail']['note_check'] ?? null) }}"
                    ...
                    <div class="row col-md-12">
                        <div class="d-md-inline-flex col-sm-12 mb-2">
                            ...
                            <div class="col-sm-4 d-inline-flex">
                                ...
                                <input type="text" name="amount_transfer" id="amount_transfer" value="{{ old('amount_transfer', $target_record_data['depositOrderDetail']['amount_transfer_comma'] ?? 0) }}"
                            ...
                            <div class="col-sm-5 d-inline-flex">
                                ...
                                <input type="text" name="note_transfer" id="note_transfer" value="{{ old('note_transfer', $target_record_data['depositOrderDetail']['note_transfer'] ?? null) }}"
                    ...
                    <div class="row col-md-12">
                        <div class="d-md-inline-flex col-sm-12">
                            ...
                            <div class="col-sm-4 d-inline-flex">
                                ...
                                <input type="text" name="amount_bill" id="amount_bill" value="{{ old('amount_bill', $target_record_data['depositOrderDetail']['amount_bill_comma'] ?? 0) }}"
                            ...
                            <div class="col-sm-5 d-inline-flex">
                                ...
                                <input type="text" name="note_bill" id="note_bill" value="{{ old('note_bill', $target_record_data['depositOrderDetail']['note_bill'] ?? null) }}"
                    ...
                    <div class="row col-md-12">
                        <div class="d-md-inline-flex col-sm-12">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="date" name="bill_date" value="{{ old('bill_date', $target_record_data['depositOrderBill']['bill_date'] ?? null) }}"
                                       class="form-control form-control-sm input-bill-date{{ $errors->has('bill_date') ? ' is-invalid' : '' }}" id="bill_date" max="{{ $default_max_date }}">
                        ...
                        <div class="d-md-inline-flex col-sm-12 mb-2">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="bill_number" id="bill_number" value="{{ old('bill_number', $target_record_data['depositOrderBill']['bill_number'] ?? null) }}"
                    ...
                    <div class="row col-md-12">
                        <div class="d-md-inline-flex col-sm-12 mb-2 order-2 order-md-1">
                            ...
                            <div class="col-sm-4 d-inline-flex">
                                ...
                                <input type="text" name="amount_offset" id="amount_offset" value="{{ old('amount_offset', $target_record_data['depositOrderDetail']['amount_offset_comma'] ?? 0) }}"
                            ...
                            <div class="col-sm-5 d-inline-flex">
                                ...
                                <input type="text" name="note_offset" id="note_offset" value="{{ old('note_offset', $target_record_data['depositOrderDetail']['note_offset'] ?? null) }}"
                    ...
                    <div class="row col-md-12">
                        <div class="d-md-inline-flex col-sm-12 mb-2">
                            ...
                            <div class="col-sm-4 d-inline-flex">
                                ...
                                <input type="text" name="amount_discount" id="amount_discount" value="{{ old('amount_discount', $target_record_data['depositOrderDetail']['amount_discount_comma'] ?? 0) }}"
                            ...
                            <div class="col-sm-5 d-inline-flex">
                                ...
                                <input type="text" name="note_discount" id="note_discount" value="{{ old('note_discount', $target_record_data['depositOrderDetail']['note_discount'] ?? null) }}"
                    ...
                    <div class="row col-md-12">
                        <div class="d-md-inline-flex col-sm-12 mb-2">
                            ...
                            <div class="col-sm-4 d-inline-flex">
                                ...
                                <input type="text" name="amount_fee" id="amount_fee" value="{{ old('amount_fee', $target_record_data['depositOrderDetail']['amount_fee_comma'] ?? 0) }}"
                            ...
                            <div class="col-sm-5 d-inline-flex">
                                ...
                                <input type="text" name="note_fee" id="note_fee" value="{{ old('note_fee', $target_record_data['depositOrderDetail']['note_fee'] ?? null) }}"
                    ...
                    <div class="row col-md-12">
                        <div class="d-md-inline-flex col-sm-12 mb-2">
                            ...
                            <div class="col-sm-4 d-inline-flex">
                                ...
                                <input type="text" name="amount_other" id="amount_other" value="{{ old('amount_other', $target_record_data['depositOrderDetail']['amount_other_comma'] ?? 0) }}"
                            ...
                            <div class="col-sm-5 d-inline-flex">
                                ...
                                <input type="text" name="note_other" id="note_other" value="{{ old('note_other', $target_record_data['depositOrderDetail']['note_other'] ?? null) }}"
            ...
            <div class="row col-md-12">
                <div class="d-md-inline-flex col-sm-12 mb-2 pt-4">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" name="billing-balance" id="billing-balance" value="-"
                            class="form-control form-control-sm input-customer-billing-balance text-right{{ $errors->has('billing-balance') ? ' is-invalid' : '' }}"
                            style="font-size: 1.5em" disabled>

                        @error('billing-balance')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
                ...
                <div class="d-md-inline-flex col-sm-12 mb-2">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" name="deposit-subtotal" id="deposit-subtotal" value="0"
                            class="form-control form-control-sm input-deposit-subtotal text-right{{ $errors->has('deposit-subtotal') ? ' is-invalid' : '' }}"
                            style="font-size: 1.5em" disabled>

                        @error('deposit-subtotal')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
                <div class="d-md-inline-flex col-sm-12 mb-2">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" name="adjust-subtotal" id="adjust-subtotal" value="0"
                ...
                <div class="d-md-inline-flex col-sm-12 p-2 border border-primary"
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" name="deposit" id="deposit" value="{{ $target_record_data['deposit_comma'] ?? 0 }}"
                            class="form-control form-control-sm input-deposit text-right{{ $errors->has('deposit') ? ' is-invalid' : '' }}"
                            style="font-size: 1.5em" disabled>
                ...
                <div class="d-md-inline-flex col-sm-12 mt-2">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" name="balance-after-deposit" id="balance-after-deposit" value="0"
                            class="form-control form-control-sm input-balance-after-deposit text-right{{ $errors->has('balance-after-deposit') ? ' is-invalid' : '' }}"
                            style="font-size: 1.5em" disabled>

                        @error('balance-after-deposit')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
    ...
    <div>
        ...
        {{-- 締処理確認用API --}}
        <input type="hidden" name="api_is_closing_url" value="{{ route('api.charge_closing.is_closing') }}" class="hidden-api-is-closing-url">
        {{-- 請求残高取得用API --}}
        <input type="hidden" name="api_get_billing_balance" value="{{ route('api.customers.get_billing_balance') }}" class="hidden-api-get-billing-balance-url">
    ...
    <div class="buttons-area text-center mt-2">
        <a id="return" class="btn btn-primary back_active"
           href="{{ session($session_common_key, route('sale.deposits.index')) }}">
            一覧画面へ戻る
        </a>

        @if (config('consts.default.deposit_order.use_clear_button'))
    ...
    @if ($is_edit_route)
        ...
        <form name="deleteForm" id="deleteForm" action="{{ route('sale.deposits.destroy', $target_record_data['id']) }}" method="POST">
        @csrf
        @method('DELETE')
        </form>

        <form name="copyForm" id="copyForm" action="{{ route('sale.deposits.copy_order') }}" >
        @csrf
    ...
    {{-- JS読み込み --}}
    <script src="{{ mix('js/app/sale/deposits/create_edit.js') }}"></script>
