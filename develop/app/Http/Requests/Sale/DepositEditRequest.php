 ...
 * 入金伝票作成編集用 リクエストクラス
 */
class DepositEditRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'customer_id' => ['bail', 'required', 'integer',
                'exists:' . with(new MasterCustomer())->getTable() . ',id,deleted_at,NULL', ],
            ...
            'note' => ['bail', 'nullable', 'string', 'max:' . DepositOrderConst::NOTE_MAX_LENGTH],
            ...
            'note_cash' => ['bail', 'nullable', 'string', 'max:' . DepositOrderConst::NOTE_DETAIL_MAX_LENGTH],
            'note_check' => ['bail', 'nullable', 'string', 'max:' . DepositOrderConst::NOTE_DETAIL_MAX_LENGTH],
            'note_transfer' => ['bail', 'nullable', 'string', 'max:' . DepositOrderConst::NOTE_DETAIL_MAX_LENGTH],
            'note_bill' => ['bail', 'nullable', 'string', 'max:' . DepositOrderConst::NOTE_DETAIL_MAX_LENGTH],
            'note_offset' => ['bail', 'nullable', 'string', 'max:' . DepositOrderConst::NOTE_DETAIL_MAX_LENGTH],
            'note_discount' => ['bail', 'nullable', 'string', 'max:' . DepositOrderConst::NOTE_DETAIL_MAX_LENGTH],
            'note_fee' => ['bail', 'nullable', 'string', 'max:' . DepositOrderConst::NOTE_DETAIL_MAX_LENGTH],
            'note_other' => ['bail', 'nullable', 'string', 'max:' . DepositOrderConst::NOTE_DETAIL_MAX_LENGTH],
