...
class MasterClassification2 extends Model
{
    /**
     * コード用トレイト使用
     */
     ...
     * @var string
     */
    protected $table = 'm_classifications2';
    ...
    public function __construct(array $attributes = [])
    {
        ...
        // コード値の桁数セット
        $this->code_length = MasterClassifications2Const::CODE_MAX_LENGTH;
    }
    ...
    public static function getSearchResultPagenate(array $search_condition_input_data): LengthAwarePaginator
    {
        return self::query()
            ...
            ->paginate(config('consts.default.master.classifications2.page_count'));
    }
    ...
    {
        return MasterIntegrityHelper::existsUseMasterClassification2($this->id);
    }
}
