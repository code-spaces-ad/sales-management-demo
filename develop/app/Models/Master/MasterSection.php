...
class MasterSection extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        // コード値の桁数セット
        $this->code_length = MasterSectionsConst::CODE_MAX_LENGTH;
    }
    ...
    public static function getSearchResultPagenate(array $search_condition_input_data): LengthAwarePaginator
    {
        return self::query()
            ...
            ->paginate(config('consts.default.master.sections.page_count'));
    }
    ...
    {
        return MasterIntegrityHelper::existsUseMasterSection($this->id);
    }
}
