...
class MasterSummaryGroup extends Model
{
    /**
     * コード用トレイト使用
     */
     ...
     * @var string
     */
    protected $table = 'm_summary_group';
    ...
    public function __construct(array $attributes = [])
    {
        ...
        // コード値の桁数セット
        $this->code_length = MasterSummaryGroupConst::CODE_MAX_LENGTH;
    }
    ...
    public static function getSearchResultPagenate(array $search_condition_input_data): LengthAwarePaginator
    {
        return self::query()
            ...
            ->paginate(config('consts.default.master.summary_group.page_count'));
    }
    ...
    {
        return MasterIntegrityHelper::existsUseMasterSummaryGroup($this->id);
    }
}
