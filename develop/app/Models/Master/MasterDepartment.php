...
class MasterDepartment extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        // コード値の桁数セット
        $this->code_length = MasterDepartmentsConst::CODE_MAX_LENGTH;
    }
    ...
    {
        return MasterIntegrityHelper::existsUseMasterDepartment($this->id);
    }
     ...
     * @return mixed
     */
    public static function getRetailId()
    {
        return self::query()
            ->where('name', '小売部')
            ->value('id');
    ...
    {
        return $this->belongsTo(MasterOfficeFacility::class, 'department_id');
    }
