...
class MasterKind extends Model
{
    /**
     * コード用トレイト使用
     */
    ...
    public function __construct(array $attributes = [])
    {
        ...
        // コード値の桁数セット
        $this->code_length = MasterKindsConst::CODE_MAX_LENGTH;
    }
    ...
    public static function getSearchResultPagenate(array $search_condition_input_data): LengthAwarePaginator
    {
        return self::query()
            ...
            ->paginate(config('consts.default.master.kinds.page_count'));
    }
    ...
    {
        return MasterIntegrityHelper::existsUseMasterKind($this->id);
    }
}
