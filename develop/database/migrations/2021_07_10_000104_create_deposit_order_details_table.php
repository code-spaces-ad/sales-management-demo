...
use App\Consts\DB\Sale\DepositOrderDetailConst;
...
/**
 * 入金伝票詳細テーブル（deposit_order_details）作成
 */
class CreateDepositOrderDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        // テーブルコメント
        DB::statement("ALTER TABLE $table COMMENT '入金伝票詳細'");
    }
    ...
    {
        // テーブル削除
        Schema::dropIfExists('deposit_order_details');
    }
}
