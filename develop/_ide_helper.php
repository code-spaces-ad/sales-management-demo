...
namespace Illuminate\Support\Facades {
    ...
    class Auth
    {
         ...
         *
         * @return \App\Models\Master\MasterUser|null
         * @static
         */
         ...
         *
         * @param mixed $id
         * @return \App\Models\Master\MasterUser|false
         * @static
         */
         ...
         *
         * @return \App\Models\Master\MasterUser
         * @static
         */
...
namespace Illuminate\Support {
    ...
    class Collection
    {
         ...
         * @param mixed $filters
         * @static
         * @see \App\Mixins\ExcelMacros::exportExcel()
         */
        public static function exportExcel($filename = '', $headings = [], $filters = [])
        {
            return \Illuminate\Support\Collection::exportExcel($filename, $headings, $filters);
        }
...
namespace App\Consts\DB\Receive {
    /**
     * 受注伝票テーブル用定数クラス
     *
     * @package App\Consts\DB\Receive
     */
    class OrdersReceivedConst
    {
     ...
     * @package App\Consts\DB\Receive
     */
    class OrdersReceivedDetailConst
    {
...
namespace App\Consts\DB\Inventory {
     ...
     * 在庫テーブル用定数クラス
     *
     * @package App\Consts\DB\Inventory
     */
     ...
     * @package App\Consts\DB\Inventory
     */
    class InventoryDataDetailConst
    {
...
namespace App\Consts\DB\Trading {
     ...
     * @package App\Consts\DB\Trading
     */
    class PurchaseOrderDetailConst
    {
...
namespace {
    ...
    class MasterUsersConst extends \App\Consts\DB\Master\MasterUsersConst
    {
    }

    class MasterCustomersConst extends \App\Consts\DB\Master\MasterCustomersConst
    {
    }

    class MasterSuppliersConst extends \App\Consts\DB\Master\MasterSuppliersConst
    {
    }

    class MasterWarehousesConst extends \App\Consts\DB\Master\MasterWarehousesConst
    {
    }

    class MasterEmployeesConst extends \App\Consts\DB\Master\MasterEmployeesConst
    {
    }

    class MasterProductsConst extends \App\Consts\DB\Master\MasterProductsConst
    {
    }

    class MasterBizPartnersConst extends \App\Consts\DB\Master\MasterBizPartnersConst
    {
    }

    class MasterCustomerPriceConst extends \App\Consts\DB\Master\MasterCustomerPriceConst
    {
    }

    class HeadOfficeInfoConst extends \App\Consts\DB\System\HeadOfficeInfoConst
    {
    }

    class OrdersReceivedConst extends \App\Consts\DB\Receive\OrdersReceivedConst
    {
    }

    class OrdersReceivedDetailConst extends \App\Consts\DB\Receive\OrdersReceivedDetailConst
    {
    }

    class SalesOrderConst extends \App\Consts\DB\Sale\SalesOrderConst
    {
    }

    class SalesOrderDetailConst extends \App\Consts\DB\Sale\SalesOrderDetailConst
    {
    }

    class DepositOrderConst extends \App\Consts\DB\Sale\DepositOrderConst
    {
    }

    class DepositOrderDetailConst extends \App\Consts\DB\Sale\DepositOrderDetailConst
    {
    }

    class InventoryDataConst extends \App\Consts\DB\Inventory\InventoryDataConst
    {
    }

    class InventoryDataDetailConst extends \App\Consts\DB\Inventory\InventoryDataDetailConst
    {
    }

    class PurchaseOrderConst extends \App\Consts\DB\Trading\PurchaseOrderConst
    {
    }

    class PurchaseOrderDetailConst extends \App\Consts\DB\Trading\PurchaseOrderDetailConst
    {
    }

    class ContractorType extends \App\Enums\ContractorType
    {
    }

    class DepositType extends \App\Enums\DepositType
    {
    }

    class OrderStatus extends \App\Enums\OrderStatus
    {
    }

    class OrderType extends \App\Enums\OrderType
    {
    }

    class ReducedTaxFlagType extends \App\Enums\ReducedTaxFlagType
    {
    }

    class RoundingMethodType extends \App\Enums\RoundingMethodType
    {
    }

    class UserRoleType extends \App\Enums\UserRoleType
    {
    }

    class DepositMethodType extends \App\Enums\DepositMethodType
    {
    }

    class TaxCalcType extends \App\Enums\TaxCalcType
    {
    }

    class TaxType extends \App\Enums\TaxType
    {
    }

    class TransactionType extends \App\Enums\TransactionType
    {
    }

    class LogHelper extends \App\Helpers\LogHelper
    {
    }

    class StringHelper extends \App\Helpers\StringHelper
    {
    }
    ...
    class SalesClassification extends \App\Enums\SalesClassification
    {
    }
}
